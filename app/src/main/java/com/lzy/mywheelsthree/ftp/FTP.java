...
public class FTP {
     ...
     * @throws IOException
     */
    public void uploadSingleFile(File singleFile, String remotePath,String Name, UploadProgressListener listener) throws IOException {
     ...
     * @throws IOException
     */
    private boolean uploadingSingle(File localFile, String name ,
                                    UploadProgressListener listener) throws IOException {
        boolean flag = true;
        // 不带进度的方式
        // // 创建输入流
        ...
        ProgressInputStream progressInput = new ProgressInputStream(buffIn,
                listener, localFile);
        flag = ftpClient.storeFile(new String(name.getBytes("UTF-8"),"iso-8859-1"), progressInput);

        Log.d(TAG, "uploadingSingle: "+flag);
        buffIn.close();
